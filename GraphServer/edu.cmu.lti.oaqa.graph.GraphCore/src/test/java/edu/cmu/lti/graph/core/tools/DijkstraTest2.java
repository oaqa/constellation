...
import edu.cmu.lti.oaqa.graph.core.tools.Dijkstra2;
import edu.cmu.lti.oaqa.graph.core.tools.NoPathFoundException;
import edu.cmu.lti.oaqa.graph.core.tools.Path2;
	...
	private void doTests() throws NoPathFoundException{
		...
		for(Vertex v1: vertices){
			for (Vertex v2:vertices){
				try{
					Path2 shortestPath = Dijkstra2.findShortestPath(v1,v2,"distance");
